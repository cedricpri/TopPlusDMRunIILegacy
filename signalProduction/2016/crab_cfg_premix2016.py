...
config.General.requestName = 'DMscalar_Dilepton_top_tWChan_Mchi1_Mphi1000_RunIISummer16_PREMIX_PrivateFullProd'
...
config.Data.outputDatasetTag = 'DMscalar_Dilepton_top_tWChan_Mchi1_Mphi1000_RunIISummer16_PREMIX_PrivateFullProd'
