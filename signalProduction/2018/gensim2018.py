...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/EXO-RunIIFall18GS-02825-fragment.py nevts:79'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:DMscalar_Dilepton_top_tWChan_Mchi1_Mphi100_RunIIAutumn18_GENSIM_PrivateProd.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
            #GridpackPath = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.6.1/ttbarDM_inclusive_DMsimp_LO/ttbarDM__dilepton__DMsimp_LO_s_spin0__mchi_1_mphi_50_gSM_1_gDM_1_6500GeV_slc6_amd64_gcc630_CMSSW_9_3_8_tarball.tar.xz'),
	    GridpackPath = cms.string('/srv/CMSSW_10_2_16_patch1/DMScalar_top_tWChan_Mchi1_Mphi1000_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
