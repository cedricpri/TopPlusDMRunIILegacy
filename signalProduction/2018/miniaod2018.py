...
# with command line options: step1 --fileout file:EXO-RunIIAutumn18MiniAOD-02428.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v15 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename EXO-RunIIAutumn18MiniAOD-02428_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 8597
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIIAutumn18MiniAOD-02428.root'),
