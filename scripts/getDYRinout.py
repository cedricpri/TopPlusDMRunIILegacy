...
for channel in channels:
    ...
    for metBin in metBins:
        ...
        errorRoutinMC[channel][metBin] = RoutinMC[channel][metBin] * math.sqrt((1/yieldsData['1bjetOrMore']['out'][channel][metBin]) ** 2 + (1/yieldsData['1bjetOrMore']['in'][channel][metBin]) ** 2 + (errorKappa[channel][metBin]/kappa[channel][metBin]) ** 2)
...
legend = r.TLegend(0.15, 0.74, 0.3, 0.85)
