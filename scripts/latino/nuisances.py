...
for treeNuisance in treeNuisances:
    ...
    for mcType in treeNuisanceDirs[treeNuisance]:
        if 'Down' not in treeNuisanceDirs[treeNuisance][mcType] or 'Up' not in treeNuisanceDirs[treeNuisance][mcType]:
            ...
            mcTypeName = '_'+mcType if (mcType=='FS' and not treeNuisances[treeNuisance]['MCtoFS']) else ''
...
"""
nuisances['normalization'] = {
    'name': 'CMS_normalization_'+year,
    'type': 'lnN',
    'samples': {
        'ttZ': '1.2',
        'ttW': '1.2',
...
nuisances['normalization_ttV'] = {
    'name': 'CMS_normalization_ttV_'+year,
    'type': 'lnN',
    'samples': {
        'ttZ': '1.5',
        'ttW': '1.5'
...
nuisances['normalization_VVV'] = {
    'name': 'CMS_normalization_VVV_'+year,
    'type': 'lnN',
    'samples': {
        'VVV': '1.3'
    }
...
nuisances['normalization_ttSemilep'] = {
    'name': 'CMS_normalization_ttSemilep_'+year,
    'type': 'lnN',
    'samples': {
        'ttSemilep': '1.3'
    }
...
nuisances['normalization_WW'] = {
    'name': 'CMS_normalization_WW_'+year,
    'type': 'lnN',
    'samples': {
        'WW': '1.3'
    }
...
nuisances['normalization_WZ'] = {
    'name': 'CMS_normalization_WZ_'+year,
    'type': 'lnN',
    'samples': {
        'WZ': '1.3'
    }
...
nuisances['normalization_ZZ'] = {
    'name': 'CMS_normalization_ZZ_'+year,
    'type': 'lnN',
    'samples': {
        'ZZ': '1.3'
    }
...
for sample in samples.keys():
    if not samples[sample]['isDATA']:
        nuisances['UE']['samples'][sample] = '1.015'
...
nuisances['DYnorm'] = {
    ...
    'samples' : { 'DY': '1.00' },
    'type'  : 'rateParam',
    'cuts'  : [ 'dyCR_ll', 'topCR_ll' ]
}
"""
"""
nuisances['ttbarNorm'] = {
    'name': 'ttbarNorm_' + year,
    'samples' : { 'ttbar': '1.00' },
    'type'  : 'rateParam',
    'cuts'  : [ 'topCR_ll' ]
}

nuisances['singleTopNorm'] = {
    'name': 'singleTopNorm_' + year,
    'samples' : { 'STtW': '1.00' },
    'type'  : 'rateParam',
    'cuts'  : [ 'topCR_ll' ]
}
